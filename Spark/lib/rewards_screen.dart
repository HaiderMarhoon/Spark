  ...
  Future<void> _fetchRewardsData() async {
    ...
    try {
      ...
      final fetchedRewards = [
        ...
        Reward(id: 'r3', title: 'Smart Karak Mug', description: 'Get a Smart Karak Mug!', pointsCost: 2500, icon: Icons.thermostat_rounded),
        Reward(id: 'r4', title: 'Plant a Tree', description: 'We\'ll plant a tree in Zallaq to help the environment!', pointsCost: 500, icon: Icons.park_rounded),
